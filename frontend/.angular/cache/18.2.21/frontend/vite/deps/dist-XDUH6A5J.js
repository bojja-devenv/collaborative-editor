...
function completeFromSchema(eltSpecs, attrSpecs) {
  ...
  for (let s of eltSpecs) {
    ...
    if (s.attributes) attrs = attrs.concat(s.attributes.map((s2) => {
      if (typeof s2 == "string") return allAttrs.find((a) => a.label == s2) || {
        label: s2,
        type: "property"
      };
      if (s2.values) {
  ...
  return (cx) => {
    ...
    let {
      doc
    } = cx.state, loc = findLocation(cx.state, cx.pos);
...
//# sourceMappingURL=dist-XDUH6A5J.js.map
