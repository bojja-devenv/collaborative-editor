...
var Doc = class _Doc extends ObservableV2 {
  ...
  destroy() {
    ...
    if (item !== null) {
      ...
      content.doc = new _Doc(__spreadProps(__spreadValues({
        guid: this.guid
      }, content.opts), {
        shouldLoad: false
      }));
...
var PermanentUserData = class {
   ...
   */
  setUserMapping(doc2, clientid, userDescription, {
    filter = () => true
  } = {}) {
...
var createAbsolutePositionFromRelativePosition = (rpos, doc2, followUndoneDeletions = true) => {
  ...
  if (rightID !== null) {
    ...
    if (tname !== null) {
      ...
      const {
        item
      } = followUndoneDeletions ? followRedone(store, typeID) : {
...
var YArray = class _YArray extends AbstractType {
  ...
  clone() {
    ...
    arr.insert(0, this.toArray().map((el) => el instanceof AbstractType ? (
      /** @type {typeof el} */
      el.clone()
    ) : el));
    return arr;
...
var createDocFromOpts = (guid, opts) => new Doc(__spreadProps(__spreadValues({
  guid
}, opts), {
...
//# sourceMappingURL=chunk-6J2ZCIEF.js.map
