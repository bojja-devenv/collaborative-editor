...
for (patternName in patterns) if (patterns.hasOwnProperty(patternName)) patterns[patternName] = new RegExp("^" + patterns[patternName]);
var patternName;
...
//# sourceMappingURL=dylan-UKCXTRZH.js.map
