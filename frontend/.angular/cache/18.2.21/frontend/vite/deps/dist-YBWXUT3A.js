...
var spaces = new ExternalTokenizer((input, stack) => {
  if (stack.dialectEnabled(Dialect_indented)) {
    ...
    if (input.next < 0 && stack.canShift(eof)) {
      ...
      if (input.next == newlineChar || startOfComment(input)) input.acceptToken(blankLineStart, -spaces2);
      else if (spaces2) input.acceptToken(whitespace);
...
var parser = LRParser.deserialize({
  ...
  maxTerm: 196,
  context: trackIndent,
  nodeProps: [["openedBy", 1, "InterpolationStart", 5, "InterpolationEnd", 21, "(", 43, "[", 78, "{"], ["isolate", -3, 6, 7, 26, ""], ["closedBy", 22, ")", 44, "]", 70, "}"]],
...
//# sourceMappingURL=dist-YBWXUT3A.js.map
