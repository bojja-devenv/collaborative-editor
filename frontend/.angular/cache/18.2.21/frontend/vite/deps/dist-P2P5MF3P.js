        ...
        for (; ; ) {
          ...
          if (next2 == 32 || next2 == 10) {
            ...
            for (; ; ) {
              ...
              if (comment2 < 0 || comment2 == 10) break;
              scan++;
            }
...
var inlineComment = new ExternalTokenizer((input) => {
  if (input.next != 35) return;
  input.advance();
  for (; ; ) {
    if (input.next == 10 || input.next < 0) break;
    if ((input.next == 37 || input.next == 125) && input.peek(1) == 125) break;
    input.advance();
  }
...
var parser = LRParser.deserialize({
  ...
  maxTerm: 188,
  nodeProps: [["closedBy", 1, "}}", -4, 2, 3, 4, 5, "%}", 22, ")"], ["openedBy", 9, "{{", 21, "(", 39, "{%"], ["group", -12, 11, 12, 15, 19, 23, 25, 26, 27, 28, 29, 30, 31, "Expression"]],
  skippedNodes: [0, 6],
  repeatNodeCount: 11,
...
//# sourceMappingURL=dist-P2P5MF3P.js.map
